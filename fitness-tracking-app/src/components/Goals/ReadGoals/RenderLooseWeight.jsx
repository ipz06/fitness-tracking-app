  ...
  return (
    ...
    >
      ...
      <Stack
        ...
        w={200}
        align={"center"}
        marginEnd={{ base: "auto", sm: "14" }}
      >
        <Text fontFamily={"sans-serif"} fontStyle={"normal"}>
          {currentWeight} kg
        </Text>
        <Text
          fontSize={"sm"}
        ...
        <Text
          ...
          fontStyle={"normal"}
        >
          {Math.abs(currentWeight - targetWeight)} kg to{" "}
          {currentWeight - targetWeight > 0 ? "loose" : "gain"}
        </Text>
      </Stack>
      <Spacer />
      <Box margin={"auto"} marginRight={{ base: "auto", sm: "50px" }}>
        <WeightPieChart
          value={50 + ((currentWeight - targetWeight) / 50) * 100}
        />
      </Box>
      {owner && (
        <Stack
