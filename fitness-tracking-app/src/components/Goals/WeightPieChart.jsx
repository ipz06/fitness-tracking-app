...
const WeightPieChart = ({value}) => {
   const RADIAN = Math.PI / 180;
   const data = [
   { name: 'A', value: 35, color: '#edf2f7' },
   { name: 'B', value: 15, color: '#00c49f' },
   { name: 'B', value: 15, color: redColor },
   { name: 'C', value: 35, color: '#edf2f7' }
   ];
   const cx = 50;
   const cy = 50;
   const iR = 30;
