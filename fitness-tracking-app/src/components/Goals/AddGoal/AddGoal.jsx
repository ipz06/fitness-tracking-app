import { Card, FormControl, Select, CardBody } from "@chakra-ui/react";
...
const AddGoal = ({ open, setOpen }) => {
  ...
  const renderInput = (goal, open, setOpen) => {
    if (goal === "stay-toned") {
      return <StayToned open={open} setOpen={setOpen} />;
    } else if (goal === "stay-active") {
      return <StayActive open={open} setOpen={setOpen} />;
    } else if (goal === "loose-weight") {
      return <LooseWeight open={open} setOpen={setOpen} />;
    } else if (goal === "daily-calories") {
      return <TrackCalories open={open} setOpen={setOpen} />;
    }
  };
  return (
    <>
