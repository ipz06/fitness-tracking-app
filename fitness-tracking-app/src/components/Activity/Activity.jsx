...
import { FaTrash, FaCalendarAlt, FaEdit, FaCheckDouble } from "react-icons/fa";
      ...
      <VStack align="center">
        <Flex align="center">
          ...
          <Box paddingLeft="25px">
            <VStack spacing={1}>
              <Tooltip label="Activity done" fontSize="md">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    onAddToLog(type, duration, caloriesBurned, addedOn)
                  }
                  mt={-2}
              ...
              <Tooltip label="Delete activity" fontSize="md">
                <Button
              ...
              <Tooltip label="Edit activity" fontSize="md">
                <Button
