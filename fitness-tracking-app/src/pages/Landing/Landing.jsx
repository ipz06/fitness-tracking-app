    ...
    const usersCounting = async () => {
      ...
      const goalCounting = async () => {
        try {
            ...
            const goalCountOfUsers = Object.values(fetchGoalCount)
                .reduce((acc, obj) => acc + (Object.keys(obj)).length, 0)
      ...
      const mealCounting = async () => {
        try {
            ...
            const mealCountOfUsers = Object.values(fetchMealCount)
                .reduce((acc, obj) => acc + (Object.keys(obj)).length, 0)
        ...
        >
            ...
            >
             ...
             <Text 
                    ...
                    fontSize="2xs"
                    >
                    Active Users: {Object.keys(usersCount).length} Created Goals: {goalCount} Created Meals: {mealCount}
                </Text>
